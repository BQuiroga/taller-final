...
class Band < ActiveRecord::Base
  ...
  def sleepy #
    ...
    if (edad<=15 && edad>0)
      sq=80
    elsif(edad>=16 && edad<=50 )
      sq=70

    end

    if (User.find(self.user_id).sex=='Male')
      return sq
    else
      return sq+5
    end
